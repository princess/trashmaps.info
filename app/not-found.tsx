...
export const metadata: Metadata = {
  title: 'Page Not Found | Trash Maps',
  description: "Sorry, we couldn't find the page you were looking for. Return to the map to find trash and recycling bins near you.",
}
